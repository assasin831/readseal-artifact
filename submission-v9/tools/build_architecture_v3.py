...
text('native-label',0,284,160,38,'Native A',21,True)
text('child-label',0,374,165,27,'Generated C',21,True)
text('child-via',0,400,162,24,"via B's view",20.3,color=MUTED)
